...
if($input_no =~ /\d/){
	...
	for($i = 0; $i < $stotal; $i++){
        ...
        print "<td style='text-align:center'><a href='https://cda.harvard.edu/chaser/startViewer.do\?menuItem=details\&obsid=$sobsid_list[$i]'>$sobsid_list[$i]</a></td>";

        print "<td style='text-align:center'><a href='https://cda.cfa.harvard.edu/chaser/startViewer.do\?menuItem=sequenceSummary&obsid=$obsid_list[$i]'>$seqno_list[$i]</a></td>";
	...
	print "</table>";
		...
		for($i = 0; $i < $ntotal; $i++){
			...
			print "<td style='text-align:center'>$type</td>";
            print "<td style='text-align:center'><a href='https://cda.harvard.edu/chaser/startViewer.do\?menuItem=details\&obsid=$nobsid_list[$i]'>$nobsid_list[$i]</a></td>";

            print "<td style='text-align:center'><a href='https://cda.cfa.harvard.edu/chaser/startViewer.do\?menuItem=sequenceSummary&obsid=$nobsid_list[$i]'>$nseqno_list[$i]</a></td>";
